  ...
  it('should list items on GET', function(done) {
    ...
    it('should edit an item on put', function(done) {
      chai.request(app)
        ...
        .end(function(err, res) {
          ...
          res.body.should.have.property('id');
          res.body.name.should.be.a('string');
          res.body.name.should.be.equal('Grapes');
          res.body.id.should.be.equal(2);
          storage.items.should.have.a('array');
          ...
          storage.items[1].name.should.equal('Grapes');
          done();
        });
    });
    it('should delete an item on delete', function(done) {
      ...
      .end(function(err, res) {
        ...
        storage.items[2].id.should.equal(4);
        done();
      });
    ...
    it('should post with nonvalid json');
    it('should put without an ID in the endpoint');
    it('should put with a different ID in the endpoint than the body');
    ...
    it('should delete without an ID at the endpoint');
});
